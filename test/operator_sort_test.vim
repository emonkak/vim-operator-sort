...
function! s:test_charwise() abort
...
function! s:test_blockwise() abort
  let source = [
  \   '-- @   --',
  \   '-- 1   --',
  \   '-- a   --',
  ...
  call s:do_test("j2l\<C-v>Gk6l\<Plug>(operator-sort)", source, [
  \   '-- @   --',
  \   '-- -32 --',
  \   '-- 1   --',
  \   '-- 12  --',
  ...
  call s:do_test("j2l\<C-v>Gk6l\<Plug>(operator-sort-numeric)", source, [
  \   '-- @   --',
  \   '-- B   --',
  \   '-- a   --',
  \   '-- c   --',
